...
var credentialsResetIntervalInSeconds = 3600;
(_chrome = chrome) === null || _chrome === void 0 ? void 0 : (_chrome$runtime = _chrome.runtime) === null || _chrome$runtime === void 0 ? void 0 : _chrome$runtime.onMessage.addListener(function (request, sender, sendResponse) {
  // 
  // Outgoing
  // 
  if (request.message === 'znn.requestWalletAccess') {
    ...
    var extensionWindow = window.open("popup.html", "extension_popup", "width=376,height=650,status=no,scrollbars=yes,resizable=yes");
    extensionWindow.znn = {
  ...
  if (request.message === 'znn.sendTransactionToSigning') {
    ...
    siteTabId = sender.tab.id;
    var _extensionWindow = window.open("popup.html", "extension_popup", "width=376,height=650,status=no,scrollbars=yes,resizable=yes");
    _extensionWindow.znn = {
  ...
  if (request.message === 'znn.sendAccountBlockToSend') {
    // console.log("Got message from content.js", siteTabId, request.params);
    siteTabId = sender.tab.id;
    var _extensionWindow2 = window.open("popup.html", "extension_popup", "width=376,height=650,status=no,scrollbars=yes,resizable=yes");
    _extensionWindow2.znn = {
...
var resetCredentials = function resetCredentials() {
  // console.log("Reseting wallet credentials")
  walletCredentials.name = "";
  walletCredentials.password = "";
  walletCredentials.timestamp = new Date();
};
(_chrome2 = chrome) === null || _chrome2 === void 0 ? void 0 : (_chrome2$runtime = _chrome2.runtime) === null || _chrome2$runtime === void 0 ? void 0 : _chrome2$runtime.onSuspend.addListener(function () {
  resetCredentials();
});
;
(function () {
  ...
  reactHotLoader.register(siteTabId, "siteTabId", "D:\\Projects\\zenon\\DexterLabZ\\syrius-extension-tg-mini-app\\src\\sections\\Background\\index.js");
  reactHotLoader.register(walletCredentials, "walletCredentials", "D:\\Projects\\zenon\\DexterLabZ\\syrius-extension-tg-mini-app\\src\\sections\\Background\\index.js");
  reactHotLoader.register(credentialsResetIntervalInSeconds, "credentialsResetIntervalInSeconds", "D:\\Projects\\zenon\\DexterLabZ\\syrius-extension-tg-mini-app\\src\\sections\\Background\\index.js");
  reactHotLoader.register(resetCredentials, "resetCredentials", "D:\\Projects\\zenon\\DexterLabZ\\syrius-extension-tg-mini-app\\src\\sections\\Background\\index.js");
})();
;
(function () {
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("c6c29b6a4949fee427fc")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "syrius-extension:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatesyrius_extension"] = (chunkId, moreModules, runtime) => {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/sections/Background/index.js");
/******/ 	
/******/ })()
;
